...
\label{sec:summary}
  ...
  \subsection{Multigroup Neutron Diffusion and \glsentrylong{nem}}
    ...
    \subsubsection{Local Elimination}
      ...
      computational time and the number of coefficients for each node, each
      energy group, and each direction has been reduced from five to three
      \cite{qe2paper}.
  ...
  \subsection{\glsentrylong{jfnk} Theory and Inexact Newton Condition}
    ...
    preferably. \eref{eq:inexact_newton_condition} is termed the inexact Newton
