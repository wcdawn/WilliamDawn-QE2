...
\begin{abstract}
  ...
  The \gls{jfnk} methods converges $q$-quadratically and only require a finite
  ...
  \gls{pi} method is typically preferred to solve for the fundamental eigenvalue
  and eigenvector of a reactor system.
  ...
  properly consider the importance of the \gls{ws} and do not use a $\dtilde$
