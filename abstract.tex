...
\begin{abstract}
  ...
  The \gls{jfnk} method provides $q$-quadratic convergence and only requires a
  ...
  local-elimination and attempt to improve the efficiency of the Krylov solver
  by preconditioning with a specially designed physics-based preconditioner.
  This implementation of the \gls{jfnk} method is compared to a \gls{pi} method
  and the authors conclude that ``the \gls{nem}\_\gls{jfnk} methods can greatly
  ...
  It is essential to compare optimized codes before conclusions regarding
  an improvement in methods can be made.
